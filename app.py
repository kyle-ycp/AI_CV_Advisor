...
with col1:
    ...
    if uploaded_file:
        ...
        if st.button("Generate Cover Letter"):
            ...
            st.subheader("Preview")
            # st.markdown(editable_cv)
            st.image(convert_pdf_to_image(cover_letter_pdf), caption="Generated by CV Advisor")        
            st.download_button(label="Download Template", cover_letter_docx=docx_io, file_name="Cover_Letter.docx", mime="application/vnd.openxmlformats-officedocument.wordprocessingml.document")
...
with col2:
    ...
    if "messages" not in st.session_state:
        ...
        st.session_state.messages.append({"role": "assistant", 
                                          "content": 
                                          """
                                          Hello! I'm your AI assistant, here to help you with your CV and job search. \n
